...
describe('date util', () => {
    ...
    describe('convertDateFormat', () => {
        it('should correctly convert date format', () => {
            ...
            const result = convertDateFormat(inputDateStr, inputFormat, outputFormat);
    
            expect(result).toEqual(expectedOutput);
            expect(dateFns.parse).toHaveBeenCalledWith(inputDateStr, inputFormat, expect.any(Date));
            expect(dateFns.format).toHaveBeenCalledWith(new Date(inputDateStr), outputFormat);
        });
        ...
        it('should throw error for invalid date format', () => {
            ...
            }).toThrowError(ERROR_MESSAGES.INVALID_DATE_FORMAT(inputDateStr, inputFormat));
        });
    });
